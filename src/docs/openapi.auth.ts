...
export const authSchemas: Record<string, unknown> = {
  ...
  RefreshRequest: {
    type: 'object',
    additionalProperties: false,
    description: 'Body is optional. Browser clients send the refresh token as a cookie.',
...
export const authPaths: Record<string, unknown> = {
  ...
  '/auth/me': {
    get: {
      tags: ['Authentication'],
      summary: 'Current user profile (auth projection)',
  ...
  '/auth/sessions': {
    get: {
      tags: ['Authentication'],
      summary: 'List active sessions (auth projection)',
...
export const authTags: Array<Record<string, unknown>> = [
  {
    name: 'Authentication',
    description: 'Registration, sign-in, OTP verification, password recovery, and refresh-token rotation.',
  },
  {
    name: 'Administration',
    description: 'Administrator-only operations: audit trail and user management.',
  },
]
